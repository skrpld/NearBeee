...
var (
	...
	ErrMsgNotFound                 = NewHttpError(errors.New("message not found"), http.StatusNotFound)
	ErrInvalidMsgId                = NewHttpError(errors.New("invalid message id"), http.StatusBadRequest)
)
